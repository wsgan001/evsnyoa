...
public class MsgDialogTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException{
    	...
    	sb.append(".msgtilte{float:left; text-align:left;background-image:url("+basepath+"/images/msgtitle_back.jpg); background-repeat:repeat-x;line-height:20px;letter-spacing:2px; height:20px;color:#000; width:"+titlewidth+"px;}\n");
    	...
    	sb.append("var t = 1;function flushTime(){if (t==0){closemask"+tmpid+"();}t = t-1;}setInterval('flushTime();',500);");
    	sb.append("\n");
    	sb.append("</script>\n");
    	sb.append("</div>\n");
    	//输出处理结果到页面上
