		...
		<div class="content-box">
           ...
           <h3>事件审核管理</h3>
				<ul class="content-box-tabs">
					<li><a href="#tab1" class="default-tab">事件审核</a>
					</li>
				</ul>
				<div class="clear"></div>
			</div>
								...
								<s:iterator value="pageBean.list" status="item">
									<tr>	
									   ...
									   <td >			
										...
										<td >
											<!-- Icons -->
											 <a href="<%=basePath%>event/loadEventToPass.action?eventID=<s:property value="id" />&page=<s:property value="page"/>" title="审核">审核<img
												src="<%=basePath%>admin/resources/images/icons/hammer_screwdriver.png"
												alt="审核" style="vertical-align:middle;"/> </a> 
										</td>
									</tr>
								</s:iterator>
						   </tbody>
						   <tfoot>
							<tr>
								...
								/<s:property value="pageBean.totalPage" />&nbsp;页，
										<a href="<%=basePath%>event/loadUnPassedEvent.action?page=1"
											title="首页">&laquo;首页</a>
										...
										<s:else>
											<a
												href="<%=basePath%>event/loadUnPassedEvent.action?page=<s:property value="%{pageBean.currentPage-1}"/>">&laquo;上一页</a>
										</s:else>
										<!--  <a href="#"
										...
										<s:else>
											<a
												href="<%=basePath%>event/loadUnPassedEvent.action?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页&raquo;</a>
										</s:else>
										<a
											href="<%=basePath%>event/loadUnPassedEvent.action?page=<s:property value="pageBean.totalPage"/>">尾页&raquo;</a>
									</div> <!-- End .pagination -->
									<div class="clear"></div>
								</td>
							</tr>
