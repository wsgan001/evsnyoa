		...
		<div class="content-box">
			...
			<div class="content-box-header">
				...
				<ul class="content-box-tabs">
					<li><a href="#tab1" class="default-tab">申请事件完成</a></li>
				</ul>
				<div class="clear"></div>
			</div>
			...
			<div class="content-box-content">
				<div class="tab-content default-tab" id="tab1">
					<div style="margin-left:40%;">
						<s:form action="applyEvent" method="post">
							...
							<fieldset>
								...
								<p>
									<label for="eventFile">文&nbsp;件&nbsp;上&nbsp;传:</label>
									<s:file id="eventFile" name="eventFile" />
								</p>
								...
								<p>
									<label for="completeTime">完&nbsp;成&nbsp;时&nbsp;间:</label>
									<s:textfield cssClass="text-input" id="completeTime"
										name="completeTime" size="30"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
								</p>
								<p>
									<label for="completeState">申&nbsp;请&nbsp;完&nbsp;成:</label>
									<s:select list="#{'1':'已完成'}" value="1" name="applyState"
										cssClass="small-input" id="applyState"></s:select>
								</p>
