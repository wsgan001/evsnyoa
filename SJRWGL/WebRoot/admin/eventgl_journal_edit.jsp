		...
		<div class="content-box">
			...
			<div class="content-box-content">
				<div class="tab-content default-tab" id="tab1">
				    <s:hidden name="eventID" value="jandeID"/>
					<div style="margin-left:30%;">
						<s:form action="editJournal" namespace="/journal" method="post" enctype="multipart/form-data">
						 <s:hidden name="journalID"/>
						<fieldset>
							<p>
								<label for="rzdate">日&nbsp;志&nbsp;时&nbsp;间：</label>
								<s:textfield cssClass="text-input" id="rzdate"
							   name="rzdate" size="30" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
							</p>
							<p>
								<label for="rzinfo">日&nbsp;志&nbsp;描&nbsp;述：</label>
							</p>
							<p><textarea id="editor_id" name="rzinfo" style="width:200px;height:200px;"><%=request.getAttribute("rzinfo")%></textarea></p>	
                           <!--  <p>
