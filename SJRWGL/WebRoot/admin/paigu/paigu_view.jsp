		...
		<div class="content-box">
			...
			<div class="content-box-header">
			  ...
			  <ul class="content-box-tabs">
					<li><a href="#tab1" class="default-tab">排故记录</a>
					</li>
				</ul>
				<div class="clear"></div>
			</div>
				...
				<div style="margin-left:20%;">
					<s:form action="addPaigu" namespace="/paigu">
					 <input type="hidden" name="eventID" value="${param.eventID}" /> 
						<fieldset>
						   <p>
						<label for="journalInfo">客&nbsp;户&nbsp;类&nbsp;型:</label>
						   </p>
						   
							<p>
							<label for="journalInfo">故&nbsp;障&nbsp;描&nbsp;述:</label>
							</p>
							<p><textarea id="editor_id" name="paiguInfo" style="width:200px;height:200px;"></textarea></p>	
