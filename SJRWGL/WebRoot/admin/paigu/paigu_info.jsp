...
<%@ include file="/admin/top.jsp" %>
	<div id="main-content">
		...
		<div class="content-box">
			...
			<!--步骤模块start--------------  -->
			<div class="step_div">
			    <li><div class="step_circled" id="step_circled">1</div><img alt="步骤" src="<%=basePath%>admin/resources/images/step_huishe_jiantou.png"></li>	
			    <li><div class="step_circle" id="step_circle">2</div><img alt="步骤" src="<%=basePath%>admin/resources/images/step_huishe_jiantou.png"></li>	
			...
			<div class="step_state_div">
			    ...
			    <li><div class="step_state_two" id="step_state">故障描述</div></li>
			...
			<div class="tab-content default-tab" id="tab1">
				<div style="margin-left:20%;">
					<s:form action="addPaigu" namespace="/paigu">
					 <input type="hidden" name="eventID" value="${param.eventID}" /> 
						<fieldset>
							<p>
							<label for="guzhangInfo">故&nbsp;障&nbsp;描&nbsp;述:</label>
							</p>
							<p><textarea id="editor_id" name="guzhangInfo" style="width:200px;height:200px;"></textarea></p>	
								 
				          <!-- <p>
								<label for="guzhangInfo">故&nbsp;障&nbsp;描&nbsp;述:</label>
								<s:textfield name="guzhangInfo" cssClass="text-input" id="guzhangInfo" size="30" ></s:textfield>
							</p> --> 
