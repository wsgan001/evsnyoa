...
function loadEvaluationEvent(obj){
	obj.form.action='event/loadEvaluationEvent.action';
	obj.form.submit();
	return false;
}
</script>
		...
		<div class="content-box">
           ...
           <h3>事件管理</h3>
				<ul class="content-box-tabs">
					<li><a href="#tab1" class="default-tab" >事件评价</a>
					</li> 
			...
			<div class="content-box-content">
				...
				<div class="tab-content default-tab" id="tab1">
						...
						<s:select style="width:100px;text-align:center" list="userlist" listKey="id" listValue="name" name="search_eventEngineer" cssClass="text-input" id="search_eventEngineer"></s:select>
						</s:if>	
                		<label for="search_startDate" style="margin-left:40px;">开始时间:</label>
								<s:textfield cssClass="text-input" style="width:100px;text-align:center" id="search_startDate" name="search_startDate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>		
                		<label for="search_endDate" style="margin-left:20px;">结束时间:</label>
								<s:textfield cssClass="text-input" style="width:100px;text-align:center" id="search_endDate" name="search_endDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>		
								<!-- <input type="submit" value="查询" class="text-input" /> <input type="button" value="导出" class="text-input"/> -->
								<input type="button" value="查询" onclick="loadEvaluationEvent(this)">
							...
							<tbody>
							   ...
							   <s:hidden name="eventID"/>
								<s:iterator value="pageBean_tj.list" status="item">
									<tr>	
										<td ><s:property value="%{#item.count+10*(pageBean_tj.currentPage-1)}" /></td>
									   ...
									   <td >			
										...
										<td>
											<!-- Icons -->
											<a href="<%=basePath%>event/loadEventByPjView.action?eventID=<s:property value="id" />&page_tj=<s:property value="page_tj"/>" title="评价">评价<img
												src="<%=basePath%>admin/resources/images/icons/evaluation2.png"
												alt="评价" style="vertical-align:middle;"/> </a> 
												
												<!-- <a href="localhost:8080/sjrw/charttest/jfreechartAction.action/>" target="main">查看<img
												src="<%=basePath%>admin/resources/images/icons/view.gif"
												alt="查看" style="vertical-align:middle;"/> </a> -->
												
											<a href="<%=basePath%>admin/evaluation_view_ch.jsp?eventID=<s:property value="id"/>" target="main">查看<img
												src="<%=basePath%>admin/resources/images/icons/view.gif"
												alt="查看" style="vertical-align:middle;"/> </a> 
												
												<a href="<%=basePath%>admin/evaluation_view_pi.jsp?eventID=<s:property value="id"/>" target="main">查看2<img
												src="<%=basePath%>admin/resources/images/icons/view.gif"
												alt="查看2" style="vertical-align:middle;"/> </a> 
												 
											
												
												<!-- <a href="<%=basePath%>admin/evaluation_view.jsp"target="main">评价<img
												src="<%=basePath%>admin/resources/images/icons/evaluation2.png"
												alt="查看" style="vertical-align:middle;"/> </a>  -->
										</td>
									</tr>
							...
							<tr>
								<td colspan="10">
									...
									<div class="pagination">
									       共有<s:property value="pageBean_tj.totalPage" />页，当前第&nbsp;<s:property value="pageBean_tj.currentPage"/>
								<s:property value="pageBean_tj.totalPage" />&nbsp;页，
										<a href="<%=basePath%>event/loadCompletedEvent.action?page_tj=1&search_eventEngineer=<s:property value="search_eventEngineer"/>&search_endDate=<s:property value="search_endDate"/>&search_startDate=<s:property value="search_startDate"/>"
											title="首页">&laquo;首页</a>
										...
										<s:if test="%{pageBean_tj.currentPage == pageBean_tj.totalPage}">
											<a href="javascript:void(0)"
