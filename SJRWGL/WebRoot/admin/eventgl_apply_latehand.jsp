			...
			<div class="content-box-content">
				<div class="tab-content default-tab" id="tab1">
					<div style="margin-left:40%;">
						<s:form action="applyEventLateHand" method="post"
							...
							<fieldset>
								...
								<p>
									<label for="planTime3">申&nbsp;请延&nbsp;期&nbsp;时&nbsp;间:</label>
									<s:property value="planTime3" />
								</p>
								<p>
										<label for=clsjLatereason>延&nbsp;期&nbsp;原&nbsp;因:</label>
										<s:property value="clsjLatereason" />

								</p>
								<p>
										<label for=clsjLateplan>处&nbsp;理&nbsp;计&nbsp;划:</label>
										<s:property value="clsjLateplan" />
								</p>
								<p>
								       <label for=clsjLatehand>是&nbsp;否&nbsp;同&nbsp;意:</label>
										<s:radio name="clsjLatehand" list="%{#{'1':'同意','0':'不同意'}}" value="1" theme="simple"></s:radio>
								</p>
